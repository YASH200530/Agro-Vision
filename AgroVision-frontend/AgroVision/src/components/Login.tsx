    ...
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center bg-gray-50 dark:bg-gray-900 py-12 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          >
            {isLoading ? <Loader2 className="w-6 h-6 animate-spin mx-auto" /> : t("auth.login.button")}
          </button>
        </form>

        <div className="text-center mt-6">
          <p className="text-gray-600 dark:text-gray-400 inline">{t("auth.login.no_account")} </p>
          <button
            type="button"
